...
add_global_action { 
  pattern = "/jgb2/song/bpm", 
  description = "JGB: Set the songs current BPM [32 - 999]",
...
add_global_action { 
  ...
  arguments = { argument("bpm", "number") },
  handler = function(bpm)
    print( ("************************ handling /song/bpm %d ***********************"):format(bpm) )
    song().transport.bpm = clamp_value(bpm, 32, 999)
  end,
}
...
-- renoise.app().recently_loaded_song_file
    ...
    add_global_action { 
      ...
      handler = function()
        ...
        local song_list = renoise.app().recently_loaded_song_files 
         ...
         local path_parts = split( song_list[1], "/")
